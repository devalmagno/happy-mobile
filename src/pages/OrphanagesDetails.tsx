      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.scheduleContainer}>
          ...
          <View style={[styles.scheduleItem, orphanage.open_on_weekends ? styles.scheduleItemGreen : styles.scheduleItemRed]}>
            ...
            <Text style={[styles.scheduleText, orphanage.open_on_weekends ? styles.scheduleTextGreen : styles.scheduleTextRed]}>
              {orphanage.open_on_weekends ? 'Atendemos' : 'Fechado no'} fim de semana
            </Text>
          </View>
        </View>
